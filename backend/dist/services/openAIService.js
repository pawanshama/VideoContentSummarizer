...
exports.summarizeTextWithDeepSeek = void 0;
...
const openai_1 = __importDefault(require("openai")); // Make sure this is 'openai' (uppercase O, lowercase AI)
 ...
 * @returns The summarized text, or null if an error occurs.
 */
const summarizeTextWithDeepSeek = async (text, summaryType, outputLanguage) => {
    try {
        console.log(`Summarizing text with DeepSeek AI (${summaryType}, ${outputLanguage})...`);
        const completion = await deepseek.chat.completions.create({
        ...
        console.error('Error summarizing text with DeepSeek AI:', error);
        if (error instanceof openai_1.default.APIError) { // You can specifically catch OpenAI API errors
...
exports.summarizeTextWithDeepSeek = summarizeTextWithDeepSeek;
