...
import { GeospatialCommand } from "./GeospatialCommand"; // NEW: Import GeospatialCommand
...
export class Video {
  ...
  // NEW: One-to-many relationship with GeospatialCommand
  @OneToMany(() => GeospatialCommand, geospatialCommand => geospatialCommand.video)
  geospatialCommands!: GeospatialCommand[];
}
